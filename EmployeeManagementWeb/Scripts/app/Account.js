    ...
    var objClient = {
        ...
        Events: {
            ...
            Click: function () {
                $(document).on('click', '#btnSaveReg', function () {
                    objClient.CommonMethods.Register();
                });
        ...
        CommonMethods: {
            Register: function () {
                if (objClient.CommonMethods.Validate_Flied() == true) {
                    var reqObj = {
                        ...
                        FirstName: Control().firstname.val(),
                        LastName: Control().lastname.val(),
                        EmailAddress: Control().emailaddress.val(),
                        MobileNumber: Control().mobile.val(),
                        Password: Control().password.val(),
                        ConfirmPassword: Control().confirmpassword.val(),
                ...
                objServer.Register(reqObj, function (response) {
            ...
            Validate_Flied: function () {
                if (Control().firstname.val() == '') {
                    alertify.error('Please Enter First Name'); return false;
                }
                if (Control().lastname.val() == '') {
                    alertify.error('Please Enter Last  Name:'); return false;
                }
                if (Control().emailaddress.val() == '') {
                ...
                if (Control().confirmpassword.val() == '') {
                    alertify.error('Please Enter Confirm Password'); return false;
                }
                if (Control().address.val() == '') {
                    alertify.error('Please Enter Address'); return false;
                }
                if (Control().mobile.val() == '') {
                    alertify.error('Please Enter Mobile Number'); return false;
                }
                $("#mobile").focusout(function () {
                    var mobileNum = $(this).val();
                    var validateMobNum = /^\d*(?:\.\d{1,2})?$/;
